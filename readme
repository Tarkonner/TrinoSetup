...
# Setup
## Use connectors
To make a connection to a database, a catalog needs to be added to the catalog folder in the project. How it is written changes after what kind of database you want to connect to (Dokumentation: https://trino.io/docs/current/connector.html). Remember that the file should be a .properties type.
